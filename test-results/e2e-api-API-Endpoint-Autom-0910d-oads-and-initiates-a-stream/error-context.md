...
- Name: e2e\api.spec.ts >> API Endpoint Automation Tests >> AI Endpoints Validation >> POST /api/ai/autocomplete accepts valid payloads and initiates a stream
- Location: e2e\api.spec.ts:50:9
...
Call log:
  - → POST http://127.0.0.1:3001/api/ai/autocomplete

...
- Name: e2e\api.spec.ts >> API Endpoint Automation Tests >> Document API Endpoints (Requires Auth) >> GET /api/documents/[id]/versions returns 401 Unauthorized for unauthenticated requests
- Location: e2e\api.spec.ts:9:9
...
Call log:
  - → GET http://127.0.0.1:3001/api/documents/test-doc-id-123/versions
